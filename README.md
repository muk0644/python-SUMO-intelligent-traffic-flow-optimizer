...
│   ├── simulation_results_20260218_184353.csv
│   ├── simulation_results_20260218_184353.json
│   ├── network_roadmap.png              # Network road map image
│   └── simulation_visualization_20260218_184353.png
│
...
### Method 4: Run with Python Script (Recommended)

```bash
python notebooks/traffic_simulation_analysis.py --gui
```

This will:
1. Open SUMO GUI window
2. Click the Play button to start simulation
3. Automatically collect traffic metrics
4. Generate results and visualizations
5. Save all outputs to `results/` folder
...
![Network Road Map](results/network_roadmap.png)

The network road map shows all roads/edges in the traffic network simulation.

### Traffic Density Analysis

![Traffic Density Visualization](results/simulation_visualization_20260218_184353.png)
